...
static class ComponentsModelBinder
{
    internal static async Task<IDictionary<Type, IList<ModelBindingArgument>>> BindAll(
        IEnumerable<(Type ComponentType, IList<object> Metadata)> componentsMetadata,
        HttpContext context)
    {
