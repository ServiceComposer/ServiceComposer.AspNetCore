...
namespace ServiceComposer.AspNetCore.Endpoints.Tests
{
    namespace Controllers
    {
        ...
        public class CompositionOverControllerPatchController : ControllerBase
        {
            [HttpPatch("{id}")]
            public Task<object> Patch(int id)
            {
    ...
    public class When_using_composition_over_controllers_PATCH_with_2_handlers
    {
        class TestIntegerHandler : ICompositionRequestsHandler
        {
            [HttpPatch("/api/CompositionOverControllerPost/{id}")]
        ...
        public async Task Returns_expected_response()
        {
            ...
            // Arrange
            var client = new SelfContainedWebApplicationFactoryWithWebHost<When_using_composition_over_controllers_PATCH_with_2_handlers>
            (
            ...
            // Act
            var response = await client.PatchAsync("/api/CompositionOverControllerPost/1", stringContent);
